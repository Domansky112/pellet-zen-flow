...
BEGIN
  ...
  -- GUARD: lead już rozliczony (ma kwotę). Nie nadpisujemy kwoty ani statusu
  -- płatności — inaczej „opłacone” cofa się do „czeka na przelew” i pozycja
  -- wraca do listy do zapłaty (duplikat w Płatnościach).
  IF _existing.payment_amount_gross IS NOT NULL THEN
    ...
    IF NOT _skip_wydanie AND _existing.reservation_status <> 'wydany' THEN
